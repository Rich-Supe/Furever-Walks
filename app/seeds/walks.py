...
def seed_walks():
    ...
    walk2 = Walk(name='2nd', distance=8, duration=25, date='2021-07-22', rating=0, finished=True, routeData={}, user_id=2)
    walk3 = Walk(name='Boring', distance=10, duration=50, date='2021-07-23', rating=0, finished=True, routeData={}, user_id=2)
    ...
    walk6 = Walk(name='2nd', distance=8, duration=25, date='2021-07-22', rating=5, finished=True, routeData={}, user_id=1)
    walk7 = Walk(name='Boring', distance=10, duration=50, date='2021-07-23', rating=5, finished=True, routeData={}, user_id=2)
    ...
    walk10 = Walk(name='3nd', distance=8, duration=25, date='2021-07-22', rating=0, finished=True, routeData={}, user_id=2)
    walk11 = Walk(name='Boring', distance=10, duration=50, date='2021-07-23', rating=0, finished=True, routeData={}, user_id=2)
    walk12 = Walk(name='Meh', distance=12, duration=75, date='2021-07-24', rating=2, finished=True, routeData={}, user_id=3)
    ...
    walk15 = Walk(name='long walk', distance=10, duration=50, date='2021-07-23', rating=4, finished=True, routeData={}, user_id=2)
