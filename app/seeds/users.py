...
def seed_users():
    demo = User(
        username='Demo', email='demo@AA.com', password='Password', name='Demo', bio="Welcome to Furever walks! Click distance/duration to see your stats! You can add dogs to your profile below and create your walks on the walks page!", image_url="", user_total_distance=0, user_total_walks=0, user_total_duration=0)
    marnie = User(
