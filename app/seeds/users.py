...
def seed_users():
    demo = User(
        username='Demo', email='demo@AA.com', password='Password', name='Demo', bio="I like turtles", image_url="", user_total_distance=0, user_total_walks=0, user_total_duration=0)
    marnie = User(
